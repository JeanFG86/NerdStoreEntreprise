...
namespace NSE.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<IActionResult> Login(UsuarioLogin usuarioLogin)
        {
            ...
            {
                AdicionarErroProcessamento("Usuário temporiariamente bloqueado por tentativas inválidas");
                return CustomResponse();
            }
        ...
        public async Task<ResponseMessage> RegistrarCliente(UsuarioRegistro usuarioRegistro)
        {
            ...
            try
            {
                return await _bus.RequestAsync<UsuarioRegistradoIntegrationEvent, ResponseMessage>(uusuarioRegistrado);
            }
            catch
            {
